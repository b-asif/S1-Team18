    ...
    <%@ page import="com.myapp.model.Technical" %>
        <%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            <% if (session.getAttribute("userId")==null) { response.sendRedirect("login.jsp"); return; } String
                firstName=(String) session.getAttribute("firstName"); if (firstName==null || firstName.trim().isEmpty())
                firstName="User" ; List<Technical> technicals = (List<Technical>) request.getAttribute("assessments");
                                    ...
                                    <a href="dashboard" class="sidebar-logo">
                                        <div class="sidebar-logo-icon">
                                            <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3 8l3.5 3.5L13 5" stroke="white" stroke-width="2.2"
                            ...
                            <main class="main-content">
                                ...
                                <div class="page-body">
                                    ...
                                    <% if ("missing".equals(error)) { %>
                                        <div class="error-banner visible" style="margin-bottom:16px;">Please fill in all
                                            required fields.</div>
                                        <% } else if ("server".equals(error)) { %>
                                            <div class="error-banner visible" style="margin-bottom:16px;">A server error
                                                occurred.</div>
                                            <% } %>
                                                ...
                                                <div class="section">
                                                    <div class="table-wrap">
                                                        <table class="data-table">
                                                            ...
                                                            <tbody>
                                                                <% if (technicals !=null && !technicals.isEmpty()) { for
                                                                    (Technical technical : technicals) { %>
                                                                    <tr>
                                                                        <td class="td-truncate">
                                                                            <%= technical.getAssessmentTitle() %>
                                                                        </td>
                                                                        <td class="td-muted">
                                                                            <%= technical.getAssignedDate() %>
                                                                        </td>
                                                                        <td class="td-muted">
                                                                            <%= technical.getDueDate() %>
                                                                        </td>
                                                                        <td>
                                                                            <%= technical.getCompletionStatus() %>
                                                                        </td>
                                                                        <td class="td-muted">
                                                                            <%= technical.getScoreOrPassFail() %>
                                                                        </td>
                                                                        <td class="td-truncate td-muted">
                                                                            <%= technical.getAssessmentNotes() %>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="actions-cell">
                                                                                <form method="post" action="technicals"
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        name="assessmentId"
                                                                                        value="<%= technical.getAssessmentId() %>">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="7">
                                                                                <div class="empty-state">
                                                                                    <p>No technical assessments added
                                                                                    </p>
                                                                                    <span>Click "Add Technical" to get
                                                                                        started.</span>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                            ...
                            <div class="modal">
                                <div class="modal-header">
                                    ...
                                    <button class="modal-close"
                                        onclick="document.getElementById('addModal').classList.remove('open')">X</button>
                                </div>
                                <form method="post" action="technicals">
                                    <div class="modal-body">
                                        <div class="form-stack">
                                            <input type="text" name="assessmentTitle" placeholder="Assessment Title"
                                                required>
                                            ...
                                            <input type="text" name="scoreOrPassFail" placeholder="Score / Pass / Fail">
                                            <textarea name="assessmentNotes" placeholder="Assessment Notes"></textarea>
                                        </div>
                                    </div>
