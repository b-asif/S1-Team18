    ...
    <div class="page-wrapper">
        ...
        <div class="form-panel">
            <div class="form-container">
                ...
                <div id="deletedMsg" style="display:none;padding:10px 14px;background:#fef2f2;border:1px solid #fecaca;border-radius:8px;font-size:13px;color:#dc2626;margin-bottom:16px;">
                    Your account has been permanently deleted.
                </div>

                <div id="resetMsg" style="display:none;padding:10px 14px;background:#ecfdf5;border:1px solid #a7f3d0;border-radius:8px;font-size:13px;color:#059669;margin-bottom:16px;">
