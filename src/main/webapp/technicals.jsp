...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="assessments" class="nav-item active">
                ...
                <div class="table-wrap">
                    <table class="data-table">
                        ...
                        <tbody>
	                        ...
	                        %>
                        	<tr>
	                            <td class="td-truncate"><%= technical.getAssessmentTitle() %></td>
								<td class="td-muted"><%= technical.getAssignedDate() %></td>
								<td class="td-muted"><%= technical.getDueDate() %></td>
	                            <td><%= technical.getCompletionStatus() %></td>
	                            <td class="td-muted"><%= technical.getScoreOrPassFail() %></td>
	                            <td class="td-truncate td-muted"><%= technical.getAssessmentNotes() %></td>
