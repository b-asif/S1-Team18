...
<head>
    ...
    <title>Technical assessments - TrackHire</title>
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        <p>No technical assessments yet</p>
                                        <span>Use Add assessment to create one.</span>
                                    </div>
                                </td>
                            </tr>
                            <% } %>
        ...
        <form method="post" action="technicals">
            ...
            <div class="modal-body">
                <div class="form-stack">
                    ...
                    <input type="text" name="scoreOrPassFail" placeholder="Score or pass/fail" maxlength="100">
                    <textarea name="assessmentNotes" placeholder="Notes" maxlength="4000"></textarea>
                </div>
            </div>
